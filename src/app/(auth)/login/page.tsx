...
// IMPORT FILE API AXIOS ANDA DI SINI
import api from '@/path/ke/file/api'; 
...
export function LoginForm() {
  ...
  // Gunakan isSubmitting bawaan react-hook-form pengganti useFormStatus
  ...
  const handleSubmit = async (values: z.infer<typeof LoginFormSchema>) => {
    ...
    try {
      // Menembak langsung ke Laravel melewati Server Action Next.js
      ...
      if (response.success || response.data) {
        ...
        // Set Cookie secara manual di sisi client (Sama amannya dengan httpOnly: false)
  ...
  return (
    <Card>
      ...
      <CardContent className='space-y-2'>
        <Form {...form}>
          {/* Gunakan form.handleSubmit untuk memvalidasi Zod sebelum mengeksekusi API */}
